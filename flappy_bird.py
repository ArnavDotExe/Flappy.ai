...
BIRD_IMG = load_image_without_background("resources/index.png", (BIRD_SIZE, BIRD_SIZE))
PIPE_IMG = load_image_without_background("resources/pipe.png", (PIPE_WIDTH, PIPE_HEIGHT))
PIPE_IMG_FLIPPED = pygame.transform.flip(PIPE_IMG, False, True)
BG_IMG = pygame.image.load("resources/background.png").convert()
